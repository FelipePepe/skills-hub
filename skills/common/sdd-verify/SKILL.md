...
## Harness #12: Verify — Evidence, Not Belief

"It works" is not evidence. "I ran the tests and they passed" is evidence.

This harness demands proof. Every scenario in the spec must be covered by a test that PASSES. Every build must succeed. Every critical risk must be acknowledged.
