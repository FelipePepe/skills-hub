---
name: docs-documentation-writer
description: Write concise, repository-aligned technical documentation.
---
...
Create or update documentation that explains conventions, workflows, commands, and maintenance rules concisely.

## Use This Skill When

Use this skill when writing README sections, governance docs, onboarding docs, ADRs, or technical guides.
...
1. Inspect existing docs and conventions.
2. Write concise sections with clear commands.
3. Link or reference existing source-of-truth files.
4. Avoid duplicating long content.
5. Validate formatting where cheap.
...
- Commands match repository conventions.
