---
name: agents-audit-skills
description: Audit skills for structure, safety, token efficiency, and catalog conventions.
---
...
Inspect existing skills and classify them without rewriting unrelated content by default.

## Use This Skill When

Use this skill when auditing the catalog, checking token efficiency, or preparing skill refactors.
...
1. Inspect likely skill locations only.
2. Apply the quality gate checklist.
3. Classify each skill as PASS, WARN, or FAIL.
4. Recommend minimal fixes.
5. Do not rewrite unrelated skills unless explicitly requested.
...
- Existing unrelated skills are not modified.
