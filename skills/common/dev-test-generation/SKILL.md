---
name: dev-test-generation
description: Create focused tests or validation checks with minimal scope and concise output.
---
...
Add or improve tests and validation checks for changed behavior without overbuilding test infrastructure.

## Use This Skill When

Use this skill when adding tests, improving coverage, or creating lightweight validation for a change.
...
1. Identify the behavior or contract to validate.
2. Reuse existing test patterns.
3. Add the smallest meaningful test or check.
4. Run targeted validation first.
5. Report any unrun validation with one note.
...
- Existing test style is followed.
- Validation is cheap and focused.
