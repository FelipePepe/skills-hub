---
name: agents-create-skill
description: Create flat, repo-compatible token-efficient skills.
---
...
Create a new `skills-hub` skill as a direct child of the correct source folder with required governance sections.

## Use This Skill When

Use this skill when creating a new reusable skill or converting a workflow into a skill.
...
5. Run skill doctor and lint when cheap.
...
- The skill passes quality gate checks.
