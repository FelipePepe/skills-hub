...
description: Review dependency and package-manager changes using safe, concise checks.
---

# Analysis Dependency Review

## Purpose

Assess dependency additions, upgrades, lockfile changes, and package-manager convention risks.

## Use This Skill When

Use this skill when dependencies, package manager files, lockfiles, or supply-chain policies are changed.
...
1. Check package manager conventions first.
2. Inspect dependency scope and necessity.
3. Prefer `pnpm` examples for JS/TS.
4. Flag package installation as requiring explicit request.
5. Summarize risks and validation gaps.
...
- `pnpm` convention is preserved.
- No package installation occurs without explicit request.
