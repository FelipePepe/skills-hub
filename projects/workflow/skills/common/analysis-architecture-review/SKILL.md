...
description: Review architecture decisions, boundaries, risks, and tradeoffs concisely.
---
...
Assess architecture, module boundaries, coupling, migration risk, and design tradeoffs before implementation or refactor.

## Use This Skill When

Use this skill for architecture review, ADR feedback, large feature planning, or dependency-boundary questions.
...
1. Read only relevant design docs and entry points.
2. Map current boundaries and proposed changes.
3. Identify risks, alternatives, and rollback options.
4. Recommend the smallest coherent path.
...
- Recommendations preserve repo conventions.
- No code is edited unless explicitly requested.
