---
name: dev-refactor
description: Refactor safely with preserved behavior, small diffs, and bounded output.
---
...
Improve structure without changing behavior, installation semantics, or public contracts.

## Use This Skill When

Use this skill when refactoring code, scripts, docs, prompts, or skills while preserving existing behavior.
...
2. Limit the refactor scope.
3. Edit in small coherent steps.
4. Validate existing checks.
5. Stop if behavior changes are required.
