...
description: Create concise agent definitions with scoped tools, safety rules, and bounded outputs.
---
...
Create new AI agent definitions that are safe, focused, and aligned with repository governance.

## Use This Skill When

Use this skill when adding or drafting an agent definition for Claude, OpenCode, or another supported assistant surface.
...
1. Identify target agent platform and source folder.
2. Reuse existing agent conventions.
3. Keep tools minimal and prompts bounded.
4. Add prompt defense and safety rules where required.
5. Validate with catalog checks when relevant.
...
- Agent definition is scoped and safe.
- Platform-specific content stays in the right source.
